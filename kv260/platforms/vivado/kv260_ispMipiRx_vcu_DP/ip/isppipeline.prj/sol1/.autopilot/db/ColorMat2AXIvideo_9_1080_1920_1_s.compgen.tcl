...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { p_dst_data244_dout { I 24 vector } p_dst_data244_num_data_valid { I 2 vector } p_dst_data244_fifo_cap { I 2 vector } p_dst_data244_empty_n { I 1 bit } p_dst_data244_read { O 1 bit } } \
} "
}
