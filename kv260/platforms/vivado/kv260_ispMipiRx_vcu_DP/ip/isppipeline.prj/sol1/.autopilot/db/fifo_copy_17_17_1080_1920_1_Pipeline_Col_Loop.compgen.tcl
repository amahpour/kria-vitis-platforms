...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { ltm_in_data242_din { O 30 vector } ltm_in_data242_num_data_valid { I 2 vector } ltm_in_data242_fifo_cap { I 2 vector } ltm_in_data242_full_n { I 1 bit } ltm_in_data242_write { O 1 bit } } \
} "
}
