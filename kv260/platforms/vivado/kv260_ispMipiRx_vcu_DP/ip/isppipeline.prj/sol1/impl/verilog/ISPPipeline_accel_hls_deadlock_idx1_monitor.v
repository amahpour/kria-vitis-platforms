...
module ISPPipeline_accel_hls_deadlock_idx1_monitor ( // for module ISPPipeline_accel_ISPPipeline_accel_inst.grp_ISPpipeline_fu_189
    input wire clock,
    input wire reset,
...
assign process_axis_block_vec[2] = idx2_block & (1'b0 | axis_block_sigs[-1] | axis_block_sigs[-1] | axis_block_sigs[-1]);
...
assign process_axis_block_vec[10] = idx6_block & (1'b0 | axis_block_sigs[-1]);
