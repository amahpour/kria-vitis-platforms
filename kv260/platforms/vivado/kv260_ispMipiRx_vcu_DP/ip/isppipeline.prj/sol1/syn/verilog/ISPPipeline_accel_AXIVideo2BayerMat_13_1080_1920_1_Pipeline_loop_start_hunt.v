...
module ISPPipeline_accel_AXIVideo2BayerMat_13_1080_1920_1_Pipeline_loop_start_hunt (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (*) begin
    if ((~((s_axis_video_TVALID == 1'b0) | (ap_start_int == 1'b0)) & (start_fu_87_p1 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign start_fu_87_p1 = s_axis_video_TUSER;

endmodule //ISPPipeline_accel_AXIVideo2BayerMat_13_1080_1920_1_Pipeline_loop_start_hunt
